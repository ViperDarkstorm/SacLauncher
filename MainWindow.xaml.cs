...
namespace SacLauncher
{
    public partial class MainWindow : Window
    {
        ...
        private void UpdateMapTypeDropdown()
        {
        ...
        {
            if (Map_list1.SelectedItem is string selectedFileName && !string.IsNullOrEmpty(folderPath))
            {
        ...
        private string GenerateConfiguration()
        {
            ...
            if (Host.IsChecked == true)
                sb.AppendLine("--zerotier-network=6ab565387ab194c6");
            else if (Guest.IsChecked == true)
                sb.AppendLine("--zerotier-network=6ab565387ab194c6").AppendLine("--join");
            ...
            sb.AppendLine($"# --map-list={Map_list1.Text}");
            if (Host.IsChecked == true || Singleplayer.IsChecked == true)
